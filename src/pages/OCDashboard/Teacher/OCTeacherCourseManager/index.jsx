...
export default function OCCourseTeacherMainPage(props){
    const { user } = useAuth()
    ...
    const handleEditCourse = (course_id)=>{
      return ()=>{
        ...
        navigate(`/dashboard/teacher/course/${course_id}`)
      }
      
    }
    const handleAddCourse = ()=>{
      navigate(`/dashboard/teacher/course/new`)
    }
      ...
      <>
        {
          ...
          <OCLoading/>
          :
          <div className='oc-teacher-course-manager'>
            <h2>課程管理</h2>
