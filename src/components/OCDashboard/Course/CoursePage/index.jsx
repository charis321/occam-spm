              ...
              <div className="oc-lesson-content-header">
                ...
                {user.role !== 0 && (
                  <div className="oc-lesson-control-btns">
                    <Button
                      type="primary"
                      onClick={handleLessonAddDisplayToggle('single')}
                    >
                      <PlusCircleOutlined />
                      新增課堂
                    </Button>
                    <Button
                      color="purple"
                      variant="solid"
                      onClick={handleLessonAddDisplayToggle('auto')}
                    >
                      <AppstoreAddOutlined />
                      自動新增課堂
                      <Popover
                        content={
                          <p>自動將課程期間內所有符合的時間段加上課堂</p>
                        }
                        title="提示"
                      >
                        <QuestionCircleOutlined />
